...
A meme classifer is a binary image classification model. It predicts whether a
given image is meme or not. In this case, we are using pretrained classifier in
